...
from app_auth.views import initial_view, RegisterView,verify_email_alert,verify_email_failed,verify_email_view, LoginView,logout_view,reset_password_email_alert,reset_password_email_failed, ResetPasswordView,ProfileView, product_detail, cart,profile, best_seller, most_viewed, contact, invoice_list, terms_and_conditions, favorites
